...
PACKAGENAME = metadata.get('package_name', 'astromatch')
DESCRIPTION = metadata.get('description', 'Statistical crossmatching of astronomical catalogues')
AUTHOR = metadata.get('author', 'A. Ruiz')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: astromatch requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
